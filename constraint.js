...
class Data_Object_Constraint extends Constraint{
	'constructor'(spec) {
...
class Data_Object_Def_Constraint extends Constraint {
...
class Field_Constraint extends Constraint {
...
class Field_Data_Type_Constraint extends Field_Constraint {
...
class Text_Constraint extends Field_Data_Type_Constraint {
...
class Not_Null_Constraint extends Field_Constraint {
...
class Guid_Constraint extends Field_Data_Type_Constraint {
...
class Number_Constraint extends Field_Data_Type_Constraint {
...
class Int_Constraint extends Number_Constraint {
